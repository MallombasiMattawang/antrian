...
<?php  // Form Add 
        ...
        // Form Detail 
        case "Detail": 
        include "daftar_administrasi_detail.php"; 
        break;  
}
}
?>
    ...
    $(document)
     ...
     // DATATABLE
        		...
        		$('#table')
                        ...
                        .dataTable({
                        sScrollY: "374px",
                        sAjaxSource: "modul/save_antrian/json_administrasi.php",
                        bDeferRender: true,
                        bStateSave: true,
                        OScroller: {
                       ...
                       aaSorting: [
                        ...
                        "fnRender": function (oObj)                              
                        {
                            ...
                            return "<a  class='btn btn-yellow' href='?link=daftar-customer-administrasi&act=Detail&id="+oObj.aData[0]+"'>View</a>";
